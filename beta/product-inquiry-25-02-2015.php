				...
				<div class="col-md-6" id="pro_inq_right">
					...
					<div class="fields">
						<select name="products" style="width:100%" class="required" tabindex="12">
							...
							<option value="Waste Paper">Waste Paper</option>
							<option value="Finish Paper">Finish Paper</option>
						</select>
					</div>
					<div class="fields">
						<textarea name="remarks" placeholder="Remarks" tabindex="15"></textarea>
					</div>
				</div>
