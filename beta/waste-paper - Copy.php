		...
		<div class="row" style="min-height:70px">
			...
			<div class="hidden" id="europe_data">
				<div class="waste-paper-column europe_colmn">
					<p><a href="waste-paper-details.php"><img src="images/address_icon.png">&nbsp;Biscuit Kraft Offer</a></p>
					<p><a href="javascript:void(0);"><img src="images/address_icon.png">&nbsp;Cyprus Super Mix</a></p>
					<p><a href="javascript:void(0);"><img src="images/address_icon.png">&nbsp;Foil Scan Board</a></p>
				</div>
				<div class="waste-paper-column europe_colmn">
					<p><a href="waste-paper-details.php"><img src="images/address_icon.png">&nbsp;KCB</a></p>
					<p><a href="waste-paper-details.php"><img src="images/address_icon.png">&nbsp;KRAFT</a></p>
					<p><a href="waste-paper-details.php"><img src="images/address_icon.png">&nbsp;Poly Cups</a></p>
				</div>
				<div class="waste-paper-column europe_colmn" style="margin-right:0px;">
					<p><a href="waste-paper-details.php"><img src="images/address_icon.png">&nbsp;Shredded Books - UK</a></p>
					<p><a href="javascript:void(0);"><img src="images/address_icon.png">&nbsp;UK Mixed Waste</a></p>
					<p><a href="javascript:void(0);"><img src="images/address_icon.png">&nbsp;Woodfree Plates Ex. Italy</a></p>
				</div>
			</div>

			<div class="hidden" id="usa_data">
				<div class="waste-paper-column usa_colmn">
					<p><a href="waste-paper-details.php"><img src="images/address_icon.png">&nbsp;DSOCC # 12</a></p>
					<p><a href="waste-paper-details.php"><img src="images/address_icon.png">&nbsp;Foil KCB + BBC + SBS</a></p>
				</div>
				<div class="waste-paper-column usa_colmn">
					<p><a href="waste-paper-details.php"><img src="images/address_icon.png">&nbsp;IFP KCB</a></p>
					<p><a href="waste-paper-details.php"><img src="images/address_icon.png">&nbsp;NDLKC</a></p>
				</div>
				<div class="waste-paper-column usa_colmn" style="margin-right:0px;">
					<p><a href="waste-paper-details.php"><img src="images/address_icon.png">&nbsp;Poly Cups</a></p>
					<p><a href="waste-paper-details.php"><img src="images/address_icon.png">&nbsp;Premium DSOCC Shoprite Quality</a></p>
				</div>
			</div>
