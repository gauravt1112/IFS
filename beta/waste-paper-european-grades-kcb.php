...
<div id="content" class="inner_content">
	...
	<div class="container" style="position:relative">
		<div class="row">
			<p class="title" align="center" style="margin-bottom:26px">KCB</p>
		</div>

		<div class="row">
			<div class="hidden" id="algeria_data" style="display:block">
				<div class="waste-paper-details">
					<div class="column_wastepaper"><img src="images/waste-paper/european-grades/kcb/01.jpg"></div>
					<div class="column_wastepaper"><img src="images/waste-paper/european-grades/kcb/02.jpg"></div>
					<div class="column_wastepaper"><img src="images/waste-paper/european-grades/kcb/03.jpg"></div>
				</div>
			</div>
		</div>
