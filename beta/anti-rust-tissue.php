...
<div id="content" class="inner_content">
	...
	<div class="container" style="position:relative">
		...
		<div class="row">
			<p class="title">Anti Rust Tissue</p>
			<p class="images">
				<img src="images/products/anti-rust-tissue-01.jpg">
			</p>
			<p>Special paper for wrapping blades to avoid corrosion.</p>
			<p class="title">Variants</p>
			<p>Range :<br> 27 - 35 gsm</p>
			<p class="title">Features</p>
			<p>Special paper for wrapping blades to avoid corrosion.</p>
			<p class="title">Uses</p>
			<p>Anti Rust Tissue</p>
		</div>
