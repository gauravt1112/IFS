...
<div id="content" class="inner_content">
	...
	<div class="container" style="position:relative">
		...
		<div class="row">
			<p class="title">Indobarr</p>
			<p class="images">
				<img src="images/products/indobarr-02.jpg">
			</p>
			<p>Coated Folding Box Board with extrusion coating of PE.</p>
			<p class="title">Variants</p>
			<p>1 PE - Coated on one side 2 PE - Coated on both sides<br/>Range :<br>Poly-extruded board for hygienic food packaging, conforming to US FDA standards.</p>
			<p class="title">Features</p>
			<p>Food grade (meets FDA 176.170 & 176.180 requirements)</p>
			<p class="title">Uses</p>
			<p>Icecream Packaging Food Packaing</p>
			<p><a href="pdf/indobarr-pe.zip" class="button">VIEW SPECIFICATION SHEETS</a></p>
		</div>
