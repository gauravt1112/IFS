...
<div id="content" class="inner_content">
	...
	<div class="container" style="position:relative">
		...
		<div class="row">
			<p class="title">White Back (Silkia)</p>
			<p class="images">
				<img src="images/placeholder.jpg">
			</p><p class="title">Products Utilities</p>
			<p>Medicine Boxes, Dry fruit products, Soaps & Cosmetics packing, Book Covers, Publication covers, Garments packing and similar others.</p>
			<p><a href="pdf/silkia_white_back.pdf" class="button" target="_blank">VIEW SPECIFICATION SHEETS</a></p>
		</div>
