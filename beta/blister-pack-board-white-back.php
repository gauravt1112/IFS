...
<div id="content" class="inner_content">
	...
	<div class="container" style="position:relative">
		...
		<div class="row">
			<p class="title">Blister Pack Board (White Back)</p>
			<p class="images">
				<img src="images/placeholder.jpg">
			</p><p class="title">Products Utilities</p>
			<p>All type of quality Blister packing where reverse side printing is also required e.g. Shaving Blades, Tooth Brush, Electronic items and similar other products.</p>
			<p><a href="pdf/blister_pack_board_both_whitegray.pdf" class="button" target="_blank">VIEW SPECIFICATION SHEETS</a></p>
		</div>
